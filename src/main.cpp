...
// Convert Cartesian Coordinates to Frenet (s,d)
vector<double> getFrenet(double x, double y, double theta, const vector<double> &maps_x, const vector<double> &maps_y)
{
	...
	// Evaluate d with respect to a center point
...
// Convert Frenet to Cartesian Coordinates (x,y)
      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
           ...
           */
            ...
            // Collitions Prevention
            if (prev_size > 0) {
              car_s = end_path_s;
            }

            // Prediction based on obs
            ...
            for ( int i = 0; i < sensor_fusion.size(); i++ ) {
                ...
                // Update position after executing previous trajectory.
            ...
            // Decision making based on boundaries
            double speed_diff = 0;
            ...
            // Convert Coordinates to vehicle local coordinates
